...
public class WebMvcConfig implements WebMvcConfigurer {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    ...
    registry.addResourceHandler("/spring/images/**").addResourceLocations("/images/").setCacheControl(CACHE_PUBLIC);
    registry.addResourceHandler("/spring/styles/**").addResourceLocations("/styles/").setCacheControl(CACHE_PUBLIC);
  }
