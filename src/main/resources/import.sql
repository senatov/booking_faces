...
insert into Hotel (id, price, name, address, city, state, zip, country) values (17, 130, 'Hotel Beaulac', ' Esplanade Löopold-Robert 2', 'Neuchatel', '', '2000', 'Switzerland');
...
insert into Hotel (id, price, name, address, city, state, zip, country) values (22, 250, 'Meliü White House', 'Albany Street', 'Regents Park London', '', 'NW13UP', 'Great Britain');
